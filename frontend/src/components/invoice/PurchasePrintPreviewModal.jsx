 ...
 * Shows A4 or 80mm thermal purchase receipt preview.
        ...
        <div className="modal-body" style={{ background: '#f0f0f0', padding: '16px 12px', overflowY: 'auto', flex: 1 }}>
          ...
          <div style={{ overflowX: 'auto', width: '100%', WebkitOverflowScrolling: 'touch' }}>
            <div ref={printRef} style={{ display: 'flex', justifyContent: 'center', minWidth: format === 'A4' ? 700 : 300, margin: '0 auto' }}>
              {format === 'A4'
                ? <A4PurchaseReceiptTemplate purchase={purchase} shopSettings={settings} />
                : <Thermal80PurchaseReceiptTemplate purchase={purchase} shopSettings={settings} />
              }
            </div>
          </div>
        </div>
